{} (:schemaVersion 2)
  :definitions $ {}
    |app.comp.container/comp-branch $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
    ...
    |app.comp.container/comp-container $ {} (:codeDynamic 0)
      ...
      :unresolved 2
      :unsafeCoerce 0
    |app.comp.container/comp-leaf $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
      ...
      :unresolved 1
      :unsafeCoerce 0
    |app.comp.container/comp-quaternary $ {} (:codeDynamic 0)
      :codeNil 3
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
      ...
      :unresolved 4
      :unsafeCoerce 0
    |app.comp.container/style-button $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
    ...
    |app.schema/store $ {} (:codeDynamic 0)
      ...
      :unresolved 1
      :unsafeCoerce 0
    |app.updater/clear-states $ {} (:codeDynamic 0)
      :codeNil 0
      :declaredOptional 0
      :deprecatedCalls 0
      :schemaDynamic 1
